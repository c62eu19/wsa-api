...
public class Security {
	...
	public String encryptUserToken(String userToken) {

		String encryptedValue = "";

		try {
			encryptedValue = this.encrypt(userToken);
		}
		catch(Exception e) {
			logger.log(
				Level.SEVERE, this.getClass().getName() + ".encryptUserToken(): ", e);
		}
		finally {}
	...
	public String decryptUserToken(String argEncryptedUserToken) {

		String decryptedValue = "";

		try {
			decryptedValue = this.decrypt(argEncryptedUserToken);
		}
		catch(Exception e) {
			logger.log(
				Level.SEVERE, this.getClass().getName() + ".decryptUserToken(): ", e);
		}
		finally {}
