...
public class DbUser {
	...
	public int updateUserSignin(HttpServletRequest request, String id, String loginCount) 
	{
		...
		try
		{
			...
			collection.updateOne(eq(
				"_id", new ObjectId(id)),
					new Document("$inc", new Document("login_count", 1)));
		}
		catch(Exception e)
		{
			statusCd = -1;
